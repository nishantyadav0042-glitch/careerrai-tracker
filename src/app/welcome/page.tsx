      ...
      <div className="sticky bottom-0 shrink-0 border-t border-stone-100 bg-white/95 px-6 pb-6 pt-4 backdrop-blur">
        <div className="mx-auto w-full max-w-xs space-y-2.5">
          ...
          {/* THE LOGIN DOOR. NEVER REMOVE IT, NEVER MAKE IT FINE PRINT.
              ...
              whose session lapsed, an app-store reviewer holding demo
              credentials) was simply locked out of their own product. A
              mentor hit exactly this on 4 Aug: "this link is taking me to
              only student portal now."
              /start carries the same door in triplicate because an
              unreachable login is the Guideline 2.1 rejection we already
              took (Incident #10). /welcome was later placed IN FRONT of
              /start and never inherited the rule — this line closes that
              gap. Bordered and stone-700 so it reads as a control. */}
          <Link
            href="/login"
            prefetch={false}
