...
// Formerly its own page (/student/reports) — now the "History" tab inside
// the merged Profile panel, alongside Profile and Settings.
      ...
      <div className="space-y-2">
        ...
        {reports.length === 0 && (
          <Card className="p-8 text-center">
            <p className="text-sm text-stone-600">Nothing yet — update topics studied today to start your streak.</p>
          </Card>
        )}
      </div>
    </div>
