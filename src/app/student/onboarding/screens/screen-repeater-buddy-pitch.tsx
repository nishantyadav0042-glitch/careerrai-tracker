...
//
// Ladder framing (founder, 20 Aug): the single session is the entry
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-orange-200 bg-orange-50/60 p-4">
        <p className="text-sm leading-relaxed text-stone-700">
          ...
          <span className="font-bold text-orange-700">{SESSION_PRICING.display}</span>, or keep one with you every month at{' '}
