    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        {lastYearPercentile != null && (
          <p className="mt-2 text-sm text-stone-600 leading-relaxed">
            {lastYearPercentile}%ile last year is real progress — not a reason to doubt yourself, a reason to fix
            what&apos;s missing.
          </p>
        )}
      </div>
      ...
      <div className="rounded-2xl border border-orange-200 bg-orange-50/60 p-4">
        <p className="text-sm leading-relaxed text-stone-700">
          ...
          <span className="font-semibold text-stone-900">IIM buddy</span>, someone who has actually cracked CAT, for
          just <span className="font-bold text-orange-700">₹999</span>. They review your prep, read every mock, and
          tell you exactly what to fix — the guidance a second attempt actually needs.
        </p>
        <p className="mt-3 text-xs font-medium text-stone-500">This offer is only shown to repeaters like you.</p>
      </div>
