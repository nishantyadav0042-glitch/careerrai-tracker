...
export async function POST(request: NextRequest) {
  try {
    ...
    const avgHours = daysLogged > 0
      ...
      : '0';
    // J3 (18 Aug) — the stress average is gone. It averaged a column the write
    // path hard-codes to 2, and it went into a prompt a buddy reads. Omitted,
    // not replaced: there is no truthful figure to substitute.
