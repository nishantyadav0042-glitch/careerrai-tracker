    ...
    <div className="min-h-screen bg-stone-50">
      <div className="max-w-3xl mx-auto px-4 py-6 pb-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-6">
          ...
          {/* ONE leads entry point (founder): the old CAT-quiz leads button is
              gone — /admin/leads is the single New Leads system. */}
          <Link
            href="/admin/leads"
          ...
          >
            <PhoneCall className="w-3.5 h-3.5" /> New Leads
          </Link>
          <Link
