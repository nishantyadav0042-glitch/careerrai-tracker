...
export interface TopicResource {
  ...
  realMinutes: number;
  /**
   * The language the video is actually TAUGHT in, established by reading the
   * transcript — never from YouTube's `defaultAudioLanguage`, which is wrong in
   * both directions: it returns `zxx` ("no linguistic content") for lectures
   * that plainly have speech, and `en` for videos taught entirely in Hindi.
   *
   * Twenty-one of the eighty-two live videos are Hindi-medium. For our students
   * that is frequently the better lesson, not the worse one — the defect was
   * never the language, it was that a student tapping an English-looking card
   * could land on a Hindi lecture with nothing having told them.
   *
   * OPTIONAL on purpose. One row (J9ccMZAG01o) would not yield a transcript
   * after three attempts, and an unlabelled row is honest where a guessed one
   * is not. An absent value shows nothing on the card, exactly as before.
   */
  language?: 'en' | 'hi';
...
export const TOPIC_RESOURCES: Record<string, TopicResource[]> = {
  "Caselets": [
    { intent: 'concept', videoId: 'Z3SWdERmAVE', language: 'hi', realMinutes: 44, views: 19333,
    ...
    { intent: 'worked_example', videoId: 'kbKFCy5HA20', language: 'hi', realMinutes: 100, longForm: true, views: 4911,
  ...
  "Ratio & Proportion": [
    ...
    { intent: 'worked_example', videoId: 'J9ccMZAG01o', realMinutes: 28, views: 195565,
      channel: "CAT Preparation - iQuanta", verifiedOn: '2026-08-31',
      title: "Arithmetic for CAT Class 1 | Ratio and Proportion | Quantitative Aptit" },
  ],
  "Vocabulary": [
    { intent: 'concept', videoId: 'Rhg1QRLnM8U', language: 'hi', realMinutes: 47, longForm: true, views: 11564,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "VOCABULARY BUILDING - HOW TO READ FROM WORD POWER MADE EASY" },
  ],
  "Arrangements": [
    { intent: 'concept', videoId: '4tI-h-GKWVk', language: 'en', realMinutes: 20, views: 845389,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Linear and Circular Arrangement - I for CAT I Logical Reasoning" },
  ],
  "Average": [
    { intent: 'concept', videoId: 'TBhanaOLNvc', language: 'en', realMinutes: 23, views: 760971,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Averages 1: Middle Term of an AP Series | Arithmetic for CAT 2026 | Ra" },
    { intent: 'worked_example', videoId: 'MYud15DuP6s', language: 'en', realMinutes: 18, views: 24179,
      channel: "Takshzila", verifiedOn: '2026-08-31',
      title: "Averages for CAT: Part 2 (More Concepts and Solved Examples)" },
  ],
  "Base System": [
    { intent: 'concept', videoId: 'yVXgLm09yuM', language: 'en', realMinutes: 56, longForm: true, views: 377,
  ...
  "Binary Logic": [
    { intent: 'concept', videoId: 'z69ElNGKPFs', language: 'en', realMinutes: 61, longForm: true, views: 3819,
      channel: "CAT Funda by Unacademy", verifiedOn: '2026-08-31',
      title: "Binary Logic / True Liar - Basic Concepts (English) l CAT 2021 l LRDI " },
  ],
  "Charts": [
    { intent: 'concept', videoId: 'Kn17_JoFmjU', language: 'en', realMinutes: 30, views: 201732,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Pie Chart 1 || LR & DI Preparation || CAT Exam Preparation" },
  ],
  "Circles": [
    { intent: 'concept', videoId: '4vj3U-tEjYE', language: 'hi', realMinutes: 45, views: 77996,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Circles 1 Basic Terms + Angle Properties | Quant Geometry 07 | CAT 202" },
    { intent: 'worked_example', videoId: 'IqfBailsqTk', language: 'en', realMinutes: 67, longForm: true, views: 3796,
      channel: "Cracku - MBA CAT Preparation", verifiedOn: '2026-08-31',
      title: "CAT 2026 Easy Geometry Circles and Polygons | CAT Geometry Important Q" },
  ],
  "Coordinate Geometry": [
    { intent: 'concept', videoId: '9t7cKr-KZ8U', language: 'hi', realMinutes: 68, longForm: true, views: 84842,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Coordinate Geometry 1 | Quant Geometry L10 | CAT 2024 | MBA Wallah" },
    { intent: 'worked_example', videoId: '0GNr5I019-I', language: 'hi', realMinutes: 76, longForm: true, views: 64517,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Coordinate Geometry- 2 | Equations of line | Quant Geometry 11 | CAT 2" },
  ],
  "Divisibility": [
    { intent: 'concept', videoId: 'p0JbJd5DpWY', language: 'en', realMinutes: 30, views: 375679,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Divisibility Rules 1 | Number System for CAT 2026 | Ravi Prakash Rodha" },
    { intent: 'worked_example', videoId: 'rb3Sk_L7vMQ', language: 'en', realMinutes: 25, views: 177488,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Divisibility Rules 4 | Number System for CAT 2026 | Ravi Prakash Rodha" },
  ],
  "Editorial Reading": [
    { intent: 'concept', videoId: 'G8IXAwpurqc', language: 'en', realMinutes: 3, views: 2084,
      channel: "Patrick100", verifiedOn: '2026-08-31',
      title: "From where should we read editorials? | AskPatrick | Patrick Dsouza |" },
  ],
  "Functions": [
    { intent: 'concept', videoId: '6FEnbG2Ux5o', language: 'en', realMinutes: 21, views: 182830,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Functions 1: Domain Range Types Of Functions | Algebra for CAT 2026 | " },
    { intent: 'worked_example', videoId: 'EWB1NaL4N4U', language: 'en', realMinutes: 19, views: 113729,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Function 2: Total Onto And Bijective Functions | Algebra for CAT 2026 " },
  ],
  "Games & Tournaments": [
    { intent: 'concept', videoId: 'bC3Wlg6DIRg', language: 'en', realMinutes: 26, views: 319239,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Games and Tournaments 1 || LR & DI Preparation for CAT || CAT Exa" },
    { intent: 'worked_example', videoId: 'zsyDbQwC1Vg', language: 'en', realMinutes: 15, views: 138298,
      channel: "ELITES GRID - CAT PREP", verifiedOn: '2026-08-31',
      title: "Games & Tournament for CAT 2025 by Gaurav Kapoor" },
  ],
  "Grammar": [
    { intent: 'concept', videoId: 'PlsBlgzhsXU', language: 'hi', realMinutes: 35, views: 28113,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Grammar (Sentence Correction & Error Spotting) for CAT & OMETs -" },
  ],
  "HCF & LCM": [
    { intent: 'concept', videoId: 'JyN6EROdhrw', language: 'en', realMinutes: 26, views: 216008,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "HCF LCM 1 | Number System for CAT 2026 | Ravi Prakash Rodha" },
    { intent: 'worked_example', videoId: '0S_rT7720t8', language: 'en', realMinutes: 20, views: 151829,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "HCF LCM 2 | Number System for CAT 2026 | Ravi Prakash Rodha" },
  ],
  "Inequalities": [
    { intent: 'concept', videoId: 'zIrr1lkvyBY', language: 'en', realMinutes: 19, views: 233003,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Inequalities 1: Rules and Applications | Algebra for CAT 2026 | R" },
    { intent: 'worked_example', videoId: 'w-ez6YnTnJ4', language: 'en', realMinutes: 15, views: 62467,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "INEQUALITIES - 9: Rational Inequality and Quadratic Range | Algeb" },
  ],
  "Linear Equations": [
    { intent: 'concept', videoId: 'W6MKuAnB0h4', language: 'en', realMinutes: 26, views: 366828,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Simple Equations 1: Linear Equation Solutions | Algebra for CAT 2026 |" },
    { intent: 'worked_example', videoId: 'b72RfaOsAmg', language: 'en', realMinutes: 15, views: 15277,
      channel: "Takshzila", verifiedOn: '2026-08-31',
      title: "Linear Eqn in 2 variables, Integer solns - 1" },
  ],
  "Lines & Angles": [
    { intent: 'concept', videoId: 'GaEZEJbKLtY', language: 'hi', realMinutes: 44, views: 214353,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Lines and Angles | Quant Geometry L1 | CAT 2024 | MBA Wallah" },
  ],
  "Logarithms": [
    { intent: 'concept', videoId: 'K6Jk3uEkIMA', language: 'en', realMinutes: 31, views: 186226,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Logarithms part 1: Logarithm Properties | Algebra for CAT 2026 |" },
    { intent: 'worked_example', videoId: 'SzseQAYENMc', language: 'en', realMinutes: 24, views: 100363,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Logarithms 2: Logarithmic Equations with Quadratic Forms | Algebr" },
  ],
  "Mensuration": [
    { intent: 'concept', videoId: 'HhtLt2JZKu4', language: 'en', realMinutes: 25, views: 171615,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Mensuration 1: Prisms, Pyramids & Spheres | Geometry for CAT 2026 | Ra" },
    { intent: 'worked_example', videoId: '17lfsV7IbR0', language: 'hi', realMinutes: 58, longForm: true, views: 36969,
      channel: "MBA Pathshala", verifiedOn: '2026-08-31',
      title: "Mensuration 2-D | CAT & OMETs | Session 01 | Udit Saini" },
  ],
  "Mixtures": [
    { intent: 'concept', videoId: '3LmRyBpIhgQ', language: 'en', realMinutes: 32, views: 560742,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Alligation and Mixture 1: Weighted Average Seesaw Method | Arithmetic" },
    { intent: 'worked_example', videoId: 'qQcGkxuf4ws', language: 'en', realMinutes: 24, views: 332784,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Alligation and Mixture 3: Alligation in Mixtures | Arithmetic for CAT" },
  ],
  "Para Summary": [
    { intent: 'concept', videoId: '8YK-4sOQyUU', language: 'en', realMinutes: 9, views: 19094,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Summary Concepts || Verbal Preparation || CAT Preparation 2019" },
    { intent: 'worked_example', videoId: 'K77dQAOf_Vg', language: 'hi', realMinutes: 34, views: 30396,
      channel: "Unacademy CAT", verifiedOn: '2026-08-31',
      title: "Ace Para Summary for CAT 2025 - \\u2018GIST\\u2019 Method" },
  ],
  "Percentages": [
    { intent: 'concept', videoId: 'x-k8iSNr85g', language: 'en', realMinutes: 26, views: 1179679,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Percentages 1: Fractions to Percentages | Arithmetic for CAT 2026" },
    { intent: 'worked_example', videoId: 'lzI_bpPpezE', language: 'en', realMinutes: 23, views: 680316,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Percentages 2: Successive Percentage Change | Arithmetic for CAT 2026" },
  ],
  "Permutation & Combination": [
    { intent: 'concept', videoId: '8kvqSY1-W5Y', language: 'en', realMinutes: 27, views: 381258,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Permutations and Combinations 1: Fundamental Principle of Counting | C" },
    { intent: 'worked_example', videoId: 'fnFjdi4XbTQ', language: 'hi', realMinutes: 59, longForm: true, views: 158823,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Permutations And Combinations - 1 | Quant Modern Maths 04 | CAT 2024 |" },
  ],
  "Pipes & Cisterns": [
    { intent: 'concept', videoId: 'kwO4buoyWHg', language: 'hi', realMinutes: 78, longForm: true, views: 57279,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Pipes & Cistern | Arithmetic  Ep. 04 | The Game Begins | CAT 2025 Prep" },
    { intent: 'worked_example', videoId: 'x3SEYdBUGaA', language: 'en', realMinutes: 20, views: 3475901,
      channel: "Dear Sir", verifiedOn: '2026-08-31',
      title: "Pipe and Cisterns Problems Tricks | Pipe and Tanki Shortcuts and Trick" },
  ],
  "Probability": [
    { intent: 'concept', videoId: 'b6hmLsjbA7E', language: 'en', realMinutes: 22, views: 148462,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Probability 1: Basics, Coin Tosses and Odds | CAT 2026 | Ravi Sir" },
    { intent: 'worked_example', videoId: '1KYf9l1wGTY', language: 'en', realMinutes: 21, views: 86507,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Probability 2: Graphical and Geometric Probability | CAT 2026 | Ravi S" },
  ],
  "Profit & Loss": [
    { intent: 'concept', videoId: 'bigCbKeUPO4', language: 'en', realMinutes: 26, views: 636219,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Profit and Loss 1: Profit, Loss, Discount, Markup | Arithmetic for CAT" },
    { intent: 'worked_example', videoId: '3Q6V7qVGReo', language: 'en', realMinutes: 39, views: 473787,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Profit and Loss 3: Faulty Weights and Cheating | Arithmetic for CAT 20" },
  ],
  "Quadratic Equations": [
    { intent: 'concept', videoId: 'X3c60CCB18U', language: 'en', realMinutes: 21, views: 148934,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Quadratic Equation 2: Nature Of Roots | Algebra for CAT 2026 | Ra" },
    { intent: 'worked_example', videoId: '27OVCl0b0nQ', language: 'en', realMinutes: 20, views: 147713,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Quadratic Equation 3: Imaginary and Common Roots | Algebra for CA" },
  ],
  "Quadrilaterals": [
    { intent: 'concept', videoId: 'TZadcVDti64', language: 'en', realMinutes: 39, views: 193526,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Quadrilaterals 1 | Geometry for CAT 2026 | Ravi Prakash Rodha" },
    { intent: 'worked_example', videoId: 'Dy4_ESXGjeY', language: 'en', realMinutes: 13, views: 112832,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Quadrilaterals 3: Trapezium & Area Questions | Geometry for CAT 2026 |" },
  ],
  "Reading Comprehension": [
    { intent: 'concept', videoId: 'Qt_FK9fWlMg', language: 'en', realMinutes: 26, views: 3294,
  ...
  "Reading Speed Practice": [
    { intent: 'concept', videoId: 'IzzDC2qCYu0', language: 'en', realMinutes: 19, views: 100045,
      channel: "Gejo Speaks", verifiedOn: '2026-08-31',
      title: "How to read a passage effectively | CAT-RC-Series | GejoSpeaks | Readi" },
  ],
  "Remainders": [
    { intent: 'concept', videoId: 'taNnRLuS4pk', language: 'hi', realMinutes: 70, longForm: true, views: 179294,
      channel: "MBA Wallah", verifiedOn: '2026-08-31',
      title: "Remainder Theorem l Quant Number System 06 | CAT 2024 l MBA Wallah" },
    { intent: 'worked_example', videoId: 'VSFs3JuKafY', language: 'en', realMinutes: 34, views: 177921,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Remainders 3: Euler's Theorem Cyclicity | Number System for CAT 2026 |" },
  ],
  "SI & CI": [
    { intent: 'concept', videoId: 'hvikOiSu_D4', language: 'en', realMinutes: 22, views: 398424,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Simple and Compound Interest 1: SI and CI Basic Concepts | Arithm" },
    { intent: 'worked_example', videoId: 'TG3M3QFyY0k', language: 'en', realMinutes: 26, views: 288757,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Simple and Compound Interest 2: SI and CI Difference Formula | Ar" },
  ],
  "Selection & Distribution": [
    { intent: 'concept', videoId: 'DcX3oOYVDh0', language: 'en', realMinutes: 12, views: 35814,
      channel: "ELITES GRID - CAT PREP", verifiedOn: '2026-08-31',
      title: "Selections and Distribution Puzzles by Elites Grid | Best Approach" },
    { intent: 'worked_example', videoId: 'd38v_cGG0Y0', language: 'hi', realMinutes: 13, views: 14936,
      channel: "ELITES GRID - CAT PREP", verifiedOn: '2026-08-31',
      title: "SELECTIONS & Distibutions | Conventional method | CAT LRDI" },
  ],
  "Sentence Completion": [
    { intent: 'concept', videoId: 'e4Ec4KzqaME', language: 'hi', realMinutes: 8, views: 14080,
      channel: "CATKing", verifiedOn: '2026-08-31',
      title: "Rules To Crack Para Completion Questions In CAT VARC | CAT Exam Verbal" },
    { intent: 'worked_example', videoId: '_K0ZbySSTzw', language: 'en', realMinutes: 28, views: 81,
      channel: "ACE CAT", verifiedOn: '2026-08-31',
      title: "VARC for CAT 2026 | Para Completion  | Lecture #06" },
  ],
  "Set Theory": [
    { intent: 'concept', videoId: 'IgEKyxYTXDg', language: 'en', realMinutes: 64, longForm: true, views: 2183,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "CAT 2025 I INTRODUCTION TO VENN Diagrams I LRDI I SWAPANIL SIR" },
    { intent: 'worked_example', videoId: 'jdusH0OI-jY', language: 'en', realMinutes: 59, longForm: true, views: 1655,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "VENN DIAGRAM SET I CAT PREVIOUS YEAR QUESTION I BY SWAPANIL SIR" },
  ],
  "Tables": [
    { intent: 'concept', videoId: 'gqYVcVjqW0k', language: 'en', realMinutes: 22, views: 134690,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Tabular Set || LR & DI Preparation for CAT || CAT exam Preparation" },
  ],
  "Time & Work": [
    { intent: 'concept', videoId: 'oApzHGJNx38', language: 'en', realMinutes: 22, views: 423047,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Time and Work 1: LCM Method Introduction | Arithmetic for CAT 202" },
    { intent: 'worked_example', videoId: '6IbA-nSj28g', language: 'en', realMinutes: 24, views: 319926,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Time and Work 2: Alternate Days and Workers Leaving | Arithmetic" },
  ],
  "Time Speed Distance": [
    { intent: 'concept', videoId: 'CKiP208avbc', language: 'en', realMinutes: 22, views: 500528,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Time Speed and Distance 1: Constant Distance Problems | Arithmeti" },
    { intent: 'worked_example', videoId: 'PQvBSkJDF_E', language: 'en', realMinutes: 24, views: 308241,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Time Speed and Distance 2: Speed Time Inverse Proportion | Arithm" },
  ],
  "Triangles": [
    { intent: 'concept', videoId: '25P2O9r3AfM', language: 'en', realMinutes: 33, views: 422192,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Triangles 1: Centroid Orthocenter Incenter Circumcenter | Geometry for" },
  ],
  "Venn / Sets": [
    { intent: 'concept', videoId: 'D3iR5cIr_VQ', language: 'en', realMinutes: 10, views: 301171,
      channel: "Rodha", verifiedOn: '2026-08-31',
      title: "Venn Diagram & Chocolate Distribution (Introduction) - 1  | LR & DI  |" },
    { intent: 'worked_example', videoId: 'dRbw57eHvuo', language: 'en', realMinutes: 30, views: 421636,
      channel: "Rodha", verifiedOn: '2026-08-31',
